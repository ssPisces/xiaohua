...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/commons/easyui/themes/default/easyui.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/commons/easyui/themes/icon.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/commons/easyui/demo/demo.css">
	<script type="text/javascript" src="${ctx}/commons/easyui/jquery.min.js"></script>
	<script type="text/javascript" src="${ctx}/commons/easyui/jquery.easyui.min.js"></script>
</head>
<body>
	<h2>Basic Form</h2>
